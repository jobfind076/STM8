...
Не смотря на то, что у SDCC есть опции поддержки с++ стандарта 23, на практике ничего выше обычного "С" не поддерживается. Приколов добавляет также своя специфика SDCC, что иногда превращает программирование поиском пути вслепую. Структуры он 100% не умеет передавать по значению.
...
Для прошивки платы нужен вот такой программатор ST-LINK V2 STM8STM32:
![](doc/stm8stm32.png)
